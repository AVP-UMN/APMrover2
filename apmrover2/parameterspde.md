...
The [Parameters.pde](https://github.com/BeaglePilot/ardupilot/blob/master/APMrover2/Parameters.pde) includes definitions and implementations related to the parameters used by the devices and ardupilot libraries.
...
...
```
This slice of code include definitions for `GSCALAR`,`GGROUP`,`GOBJECT`,`GOBJECTN`. These three refer to groups of parameters.
...
/ misc
	...
	...
	```
This slice of code includes the definition of the `log_bitmask`that derives from [k_param_log_bitmask](https://github.com/BeaglePilot/ardupilot/blob/master/APMrover2/Parameters.h#L31).Also defines `num_reset`, both parameters are imported from [Parameter.h](https://github.com/BeaglePilot/ardupilot/blob/master/APMrover2/Parameters.h#L197)
Before the definition there is a brief description of the use and the values.
...
...
```
The same is done for the rest of the parameters.
...
...
```
As the description says this slice of code is a "parameters value updater" which changes from the old parameters to the new values.
